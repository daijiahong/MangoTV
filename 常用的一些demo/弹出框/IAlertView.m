...
//  Copyright © 2018年 Wimagguc. All rights reserved.
//

#import "IAlertView.h"
#import <QuartzCore/QuartzCore.h>

//static CGFloat kAlertViewDefaultTitleHeight        = 50;  // 标题View高度
//static CGFloat kAlertViewDefaultButtonHeight       = 50;  // 按钮高度
//static CGFloat kAlertViewDefaultButtonSpacerHeight = 0.5; // 分隔线宽度
//static CGFloat kAlertViewCornerRadius              = 7;   // 圆角半径
...
- (UIView *)createContainerView
{
    ...
    if (_title.length) {
        ...
        containerViewFrame.origin.y += 50;
        containerViewFrame.size.height += 50;
    ...
    // 添加标题View
    if (_title.length) {
        _titleView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, dialogContainer.bounds.size.width, 50)];
